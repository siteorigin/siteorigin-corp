...
* Introduced a new setting at `Theme Settings > Pages > Featured Image` to control page featured image visibility.
...
= 1.7 - 30 August 2018 =
* Added WooCommerce archive Add to Cart and Quick View buttons on hover. Settings located at Customize > Theme Settings > WooCommerce.

= 1.6.5 - 21 August 2018 =
* Logo Scaling: Added filter to adjust scale and prevent constant rescaling.
* Removed post meta date formats.
* Added a check to see if WooCommerce is active before adding the header mini-cart.

= 1.6.4 - 08 August 2018 =
* Added the privacy page link to the bottom bar if a privacy page is selected.
* Resolved Jetpack Likes warning.

= 1.6.3 - 24 July 2018 =
* Added body class option to disable smooth scroll.
* Added Jetpack Like compatibility.

= 1.6.2 - 13 July 2018 =
* Removed Post Loop H1 screen reader tags.
* Removed full screen search H3 tag.

= 1.6.1 - 04 July 2018 =
* Minor WooCommerce styling adjustments.
* Fixed single post featured image setting.
* Switched Jetpack Infinite Scroll posts per page to the Jetpack Infinite Scroll setting for posts per page.

= 1.6 - 25 June 2018 =
* Prevented full screen header search markup from outputting when disabled.
* Minor styling fixes.
* Added a new search results design.
* Added four new blog layouts accessible from `Theme Settings > Blog` and the Page Builder Post Loop widget.

= 1.5.1 - 07 June 2018 =
* Resolved Customizer color settings bug. Updated Customizer settings CSS.
* Unified more tag and excerpt more link styling.

= 1.5 - 06 June 2018 =
* Added a header menu WooCommerce mini-cart. `Customize > Theme Settings > WooCommerce > Mini Cart` to enable.
* Improved styling for the WooCommerce dashboard and supplementary pages.
* Improved WooCommerce Stripe checkout styling.

= 1.4.3 - 29 May 2018 =
* Styled comment form cookie consent setting.
* Overhauled excerpt function. `siteorigin_corp_excerpt_length` and `siteorigin_corp_excerpt_more` deprecated.
